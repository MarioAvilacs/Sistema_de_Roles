...
public class EdicionUsuario extends javax.swing.JFrame {
    ...
    public EdicionUsuario(Controller control, int id_usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnEditar.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        //Trayendo al usuario mediante ID
        usu=control.traerUsuario(id_usuario);
        
        //Cargando datos del usuario seleccionado.
        txtNombreUsuario.setText(usu.getNomUsuario());
        txtPassword.setText(usu.getContrasenia());
        
        //Cargando roles desde la BD.
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        control.editarUsuario(usu,nombre, contrasenia, rol);
